...
async def start_yukki():
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk(functions.channels.JoinChannelRequest(channel="@Mm_ub_spam"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk(functions.channels.JoinChannelRequest(channel="@Mm_ub_spam"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk(functions.channels.JoinChannelRequest(channel="@Mm_ub_spam"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk(functions.channels.JoinChannelRequest(channel="@Mm_ub_spam"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk(functions.channels.JoinChannelRequest(channel="@Mm_ub_spam"))
    ...
    if tenth:
       ...
       # edk = TelegramClient(StringSession(session_name), ia, ib)
        try:
            ...
            await edk(functions.channels.JoinChannelRequest(channel="@Mm_ub_spam"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk(functions.channels.JoinChannelRequest(channel="@Mm_ub_spam"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk(functions.channels.JoinChannelRequest(channel="@Mm_ub_spam"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk(functions.channels.JoinChannelRequest(channel="@Mm_ub_spam"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk(functions.channels.JoinChannelRequest(channel="@Mm_ub_spam"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid(functions.channels.JoinChannelRequest(channel="@Mm_ub_spam"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@Mm_ub_spam"))
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@Mm_ub_spam"))
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@Mm_ub_spam"))
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@Mm_ub_spam"))
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@Mm_ub_spam"))
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@Mm_ub_spam"))
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@Mm_ub_spam"))
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@Mm_ub_spam"))
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@Mm_ub_spam"))
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@Mm_ub_spam"))
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 7:
            ...
            try:
                ...
                await event.edit("𝐉𝐎𝐢𝐍 𝐇𝐎𝐆𝐘𝐀 𝐕𝐀𝐈 𝐀𝐁 𝐁𝐓𝐀 𝐊𝐈𝐓𝐍𝐀 𝐊𝐈𝐃𝐍𝐀𝐏 𝐊𝐀𝐑𝐔😏🔥")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
