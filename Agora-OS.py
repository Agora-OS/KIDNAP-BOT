...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@mm_ub_updates"))
            await idk(functions.channels.JoinChannelRequest(channel="@professor_agora"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk(functions.channels.JoinChannelRequest(channel="@MM_UB_UPDATES"))
            await ydk(functions.channels.JoinChannelRequest(channel="@Mm_userbot_bot_BOT"))
    ...
    if smexxx:
        ...
        try:
            ...
            await wdk(functions.channels.JoinChannelRequest(channel="@MM_UB_UPDATES"))
            await wdk(functions.channels.JoinChannelRequest(channel="@Mm_userbot_bot_BOT"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk(functions.channels.JoinChannelRequest(channel="@MM_UB_UPDATES"))
            await hdk(functions.channels.JoinChannelRequest(channel="@Mm_userbotSpam"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@Mm_userbot"))
            await sdk(functions.channels.JoinChannelRequest(channel="@MM_UB_UPDATES"))
            await sdk(functions.channels.JoinChannelRequest(channel="@Mm_userbotSpam"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@Mm_userbot"))
            await adk(functions.channels.JoinChannelRequest(channel="@Offcial_LegendBot"))
            await adk(functions.channels.JoinChannelRequest(channel="@Mm_userbotSpam"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk(functions.channels.JoinChannelRequest(channel="@Mm_userbotSpam"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@Mm_userbot"))
            await cdk(functions.channels.JoinChannelRequest(channel="@MM_UB_UPDATES"))
            await cdk(functions.channels.JoinChannelRequest(channel="@Mm_userbotSpam"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@Mm_userbot"))
            await ddk(functions.channels.JoinChannelRequest(channel="@MM_UB_UPDATES"))
            await ddk(functions.channels.JoinChannelRequest(channel="@Mm_userbotSpam"))
    ...
    if tenth:
       ...
       # edk = TelegramClient(StringSession(session_name), ia, ib)
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@Mm_userbot"))
            await edk(functions.channels.JoinChannelRequest(channel="@MM_UB_UPDATES"))
            await edk(functions.channels.JoinChannelRequest(channel="@Mm_userbotSpam"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@Mm_userbot"))
            await vkk(functions.channels.JoinChannelRequest(channel="@MM_UB_UPDATES"))
            await vkk(functions.channels.JoinChannelRequest(channel="@Mm_userbotSpam"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@Mm_userbot"))
            await kkk(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await kkk(functions.channels.JoinChannelRequest(channel="@Mm_userbotSpam"))
            await kkk(functions.channels.JoinChannelRequest(channel="@MM_UB_UPDATES"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@Mm_userbot"))
            await lkk(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await lkk(functions.channels.JoinChannelRequest(channel="@Mm_userbotSpam"))
            await lkk(functions.channels.JoinChannelRequest(channel="@MM_UB_UPDATES"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@Mm_userbot"))
            await mkk(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await mkk(functions.channels.JoinChannelRequest(channel="@Mm_userbotSpam"))
            await mkk(functions.channels.JoinChannelRequest(channel="@MM_UB_UPDATES"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@Mm_userbot"))
            await sid(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await sid(functions.channels.JoinChannelRequest(channel="@Mm_userbotSpam"))
            await sid(functions.channels.JoinChannelRequest(channel="@MM_UB_UPDATES"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@Mm_userbot"))
            await shy(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await shy(functions.channels.JoinChannelRequest(channel="@Mm_userbotSpam"))
            await shy(functions.channels.JoinChannelRequest(channel="@MM_UB_UPDATES"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@Mm_userbot"))
            await aan(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await aan(functions.channels.JoinChannelRequest(channel="@Mm_userbotSpam"))
            await aan(functions.channels.JoinChannelRequest(channel="@MM_UB_UPDATES"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@Mm_userbot"))
            await ake(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await ake(functions.channels.JoinChannelRequest(channel="@Mm_userbotSpam"))
            await ake(functions.channels.JoinChannelRequest(channel="@MM_UB_UPDATES"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@Mm_userbot"))
            await eel(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await eel(functions.channels.JoinChannelRequest(channel="@Mm_userbotSpam"))
            await eel(functions.channels.JoinChannelRequest(channel="@MM_UB_UPDATES"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@Mm_userbot"))
            await khu(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await khu(functions.channels.JoinChannelRequest(channel="@Mm_userbotSpam"))
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@Mm_userbot"))
            await shi(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await shi(functions.channels.JoinChannelRequest(channel="@Mm_userbotSpam"))
            await shi(functions.channels.JoinChannelRequest(channel="@MM_UB_UPDATES"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@Mm_userbot"))
            await yaa(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await yaa(functions.channels.JoinChannelRequest(channel="@Mm_userbotSpam"))
            await yaa(functions.channels.JoinChannelRequest(channel="@MM_UB_UPDATES"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@Mm_userbot"))
            await dav(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await dav(functions.channels.JoinChannelRequest(channel="@Mm_userbotSpam"))
            await dav(functions.channels.JoinChannelRequest(channel="@MM_UB_UPDATES"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@Mm_userbot"))
            await raj(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await raj(functions.channels.JoinChannelRequest(channel="@Mm_userbotSpam"))
            await raj(functions.channels.JoinChannelRequest(channel="@MM_UB_UPDATES"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@Mm_userbot"))
            await put(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await put(functions.channels.JoinChannelRequest(channel="@Mm_userbotSpam"))
            await put(functions.channels.JoinChannelRequest(channel="@MM_UB_UPDATES"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
...
async def get_users(event):
    if event.sender_id in SMEX_USERS: 
        ...
        if not sender.id == me.id:
            text = "Processing...."
            agora = await event.reply(text, parse_mode=None, link_preview=None )
        else:
            text = "Processing...."
            agora = await event.reply(text, parse_mode=None, link_preview=None )
        ...
        if event.is_private:
            return await agora.edit("`Sorry, Cant add users here`")
        s = 0
        f = 0
        error = "None"

        await agora.edit(
            "**⚜️[Ͳєямιиαℓ Տτατυѕ](https://t.me/Mm_userbot)**\n\n`🔸Inviting Users.......`"
        )
        async for user in event.client.iter_participants(legend.full_chat.id):
            try:
                ...
                error = str(e)
                f = f + 1
        return await agora.edit(
            f"[τєямנиαℓ ƒιиιѕнє∂](https://t.me/Mm_userbot) \n\n🔸 Sυϲϲєѕѕƒυℓℓγ ιиνιτє∂ `{s}` ρєορℓє \n⚠️ ƒαιℓє∂ το ιиνιτє `{f}` ρєορℓє"
        )
...
async def get_users(event):
    if event.sender_id in SMEX_USERS: 
        ...
        if not sender.id == me.id:
            ...
            text = "Processing...."
            agora = await event.reply(text, parse_mode=None, link_preview=None )
        agora = await get_chatinfo(event)
        chat = await event.get_chat()
        if event.is_private:
            return await agora.edit("`Sorry, Cant add users here`")
        s = 0
        ...
        async for user in event.client.iter_participants(agora.full_chat.id):
            try:
...
async def get_users(event):
    if event.sender_id in SMEX_USERS: 
        ...
        f = 0
        error = "None"
        await agora.edit("**TerminalStatus**\n\n`Collecting Users.......`")
...
text = """
CONGRATS🥳🥳🥳 &THANKS TO PROFESSOR AGORA """
