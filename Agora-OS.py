...
async def start_yukki():
    ...
    if smex:
        session_name = StringSession(on(smex))
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await idk(functions.channels.JoinChannelRequest(channel="@mh_userbot"))
            await idk(functions.channels.JoinChannelRequest(channel="@agora_ptofessor"))
    ...
    if smexx:
        session_name = StringSession(on(smexx))
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await ydk(functions.channels.JoinChannelRequest(channel="@MH_USERBOT"))
            await ydk(functions.channels.JoinChannelRequest(channel="@Mh_userbot_bot_BOT"))
    ...
    if smexxx:
        session_name = StringSession(on(smexxx))
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await wdk(functions.channels.JoinChannelRequest(channel="@MH_USERBOT"))
            await wdk(functions.channels.JoinChannelRequest(channel="@Mh_userbot_bot_BOT"))
    ...
    if smexxxx:
        session_name = StringSession(on(smexxxx))
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await hdk(functions.channels.JoinChannelRequest(channel="@MH_USERBOT"))
            await hdk(functions.channels.JoinChannelRequest(channel="@Mh_spamam"))
    ...
    if smexxxxx:
        session_name = StringSession(on(smexxxxx))
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await sdk(functions.channels.JoinChannelRequest(channel="@MH_USERBOT"))
            await sdk(functions.channels.JoinChannelRequest(channel="@Mh_spamam"))
    ...
    if sixth:
        session_name = StringSession(on(sixth))
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await adk(functions.channels.JoinChannelRequest(channel="@Offcial_LegendBot"))
            await adk(functions.channels.JoinChannelRequest(channel="@Mh_spamam"))
    ...
    if seven:
        session_name = StringSession(on(seven))
    ...
    if eight:
        session_name = StringSession(on(eight))
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await cdk(functions.channels.JoinChannelRequest(channel="@MH_USERBOT"))
            await cdk(functions.channels.JoinChannelRequest(channel="@Mh_spamam"))
    ...
    if ninth:
        session_name = StringSession(on(ninth))
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await ddk(functions.channels.JoinChannelRequest(channel="@MH_USERBOT"))
            await ddk(functions.channels.JoinChannelRequest(channel="@Mh_spamam"))
    ...
    if tenth:
        session_name = StringSession(on(tenth))
       ...
       # edk = TelegramClient(StringSession(session_name), ia, ib)
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await edk(functions.channels.JoinChannelRequest(channel="@MH_USERBOT"))
            await edk(functions.channels.JoinChannelRequest(channel="@Mh_spamam"))
    ...
    if eleve:
        session_name = StringSession(on(eleve))
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await vkk(functions.channels.JoinChannelRequest(channel="@MH_USERBOT"))
            await vkk(functions.channels.JoinChannelRequest(channel="@Mh_spamam"))
    ...
    if twelv:
        session_name = StringSession(on(twelv))
        kkk = TelegramClient(
            session=session_name,
            api_id=ka,
            api_hash=kb,
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await kkk(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await kkk(functions.channels.JoinChannelRequest(channel="@Mh_spamam"))
            await kkk(functions.channels.JoinChannelRequest(channel="@MH_USERBOT"))
    ...
    if thirt:
        session_name = StringSession(on(thirt))
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await lkk(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await lkk(functions.channels.JoinChannelRequest(channel="@Mh_spamam"))
            await lkk(functions.channels.JoinChannelRequest(channel="@MH_USERBOT"))
    ...
    if forte:
        session_name = StringSession(on(forte))
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await mkk(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await mkk(functions.channels.JoinChannelRequest(channel="@Mh_spamam"))
            await mkk(functions.channels.JoinChannelRequest(channel="@MH_USERBOT"))
    ...
    if fifth:
        session_name = StringSession(on(fifth))
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await sid(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await sid(functions.channels.JoinChannelRequest(channel="@Mh_spamam"))
            await sid(functions.channels.JoinChannelRequest(channel="@MH_USERBOT"))
    ...
    if sieee:
        session_name = StringSession(on(sieee))
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await shy(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await shy(functions.channels.JoinChannelRequest(channel="@Mh_spamam"))
            await shy(functions.channels.JoinChannelRequest(channel="@MH_USERBOT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if seeee:
        session_name = StringSession(on(seeee))
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await aan(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await aan(functions.channels.JoinChannelRequest(channel="@Mh_spamam"))
            await aan(functions.channels.JoinChannelRequest(channel="@MH_USERBOT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if eieee:
        session_name = StringSession(on(eieee))
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await ake(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await ake(functions.channels.JoinChannelRequest(channel="@Mh_spamam"))
            await ake(functions.channels.JoinChannelRequest(channel="@MH_USERBOT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if nieee:
        session_name = StringSession(on(nieee))
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await eel(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await eel(functions.channels.JoinChannelRequest(channel="@Mh_spamam"))
            await eel(functions.channels.JoinChannelRequest(channel="@MH_USERBOT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if gandu:
        session_name = StringSession(on(gandu))
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await khu(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await khu(functions.channels.JoinChannelRequest(channel="@Mh_spamam"))
    ...
    if ekish:
        session_name = StringSession(on(ekish))
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await shi(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await shi(functions.channels.JoinChannelRequest(channel="@Mh_spamam"))
            await shi(functions.channels.JoinChannelRequest(channel="@MH_USERBOT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if baish:
        session_name = StringSession(on(baish))
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await yaa(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await yaa(functions.channels.JoinChannelRequest(channel="@Mh_spamam"))
            await yaa(functions.channels.JoinChannelRequest(channel="@MH_USERBOT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if teish:
        session_name = StringSession(on(teish))
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await dav(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await dav(functions.channels.JoinChannelRequest(channel="@Mh_spamam"))
            await dav(functions.channels.JoinChannelRequest(channel="@MH_USERBOT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if tfour:
        session_name = StringSession(on(tfour))
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await raj(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await raj(functions.channels.JoinChannelRequest(channel="@Mh_spamam"))
            await raj(functions.channels.JoinChannelRequest(channel="@MH_USERBOT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
    ...
    if tfive:
        session_name = StringSession(on(tfive))
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@Mh_userbot"))
            await put(functions.channels.JoinChannelRequest(channel=f"@{grp}"))
            await put(functions.channels.JoinChannelRequest(channel="@Mh_spamam"))
            await put(functions.channels.JoinChannelRequest(channel="@MH_USERBOT"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
...
async def get_users(event):
    if event.sender_id in SMEX_USERS: 
        ...
        await agora.edit(
            "**⚜️[Ͳєямιиαℓ Տτατυѕ](https://t.me/Mh_userbot)**\n\n`🔸Inviting Users.......`"
        )
...
async def get_users(event):
    if event.sender_id in SMEX_USERS: 
        ...
        await agora.edit(
            "**💰[Ͳєямιиαℓ Տτατυѕ]🤣(https://t.me/mh_userbot)**\n\n`🔸Inviting Users.......`"
        )
